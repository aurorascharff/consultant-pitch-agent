...
- Never say that a pitch was submitted unless `submit_pitch` returns `submitted: true`. A local preview result confirms approval behavior but does not deliver the pitch.
